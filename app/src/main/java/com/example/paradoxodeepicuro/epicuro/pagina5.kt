...
class pagina5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonGoToSecond = findViewById<Button>(R.id.button7)
        val buttonGoToSecond2 = findViewById<Button>(R.id.button8)
    ...
    fun goToSecondActivity() {
        val intent = Intent(this, onipotentePag6::class.java)
        startActivity(intent)
    }
    // Função para iniciar a SecondActivity
    fun goToSecondActivity2() {
        val intent = Intent(this, onipotenciaPag7::class.java)
        startActivity(intent)
    }
